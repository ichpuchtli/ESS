...
class QCP_LIB_DECL QCPLayoutElement : public QCPLayerable
{
  ...
  Q_PROPERTY( QMargins minimumMargins READ minimumMargins WRITE
              setMinimumMargins )
...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY( int tickLabelPadding READ tickLabelPadding WRITE
              setTickLabelPadding )
  ...
  Q_PROPERTY( int subTickLengthOut READ subTickLengthOut WRITE
              setSubTickLengthOut )
...
public:
  ...
  */
  ...
  Q_SLOT void setSelectableParts( const QCPAxis::SelectableParts
                                  &selectableParts );
...
protected:
  ...
  // non-virtual methods:
  void addChild( QCPItemPosition*
                 pos ); // called from pos when this anchor is set as parent
  void removeChild( QCPItemPosition
...
class QCP_LIB_DECL QCustomPlot : public QWidget
{
  ...
  Q_PROPERTY( bool backgroundScaled READ backgroundScaled WRITE
              setBackgroundScaled )
...
public:
  ...
  */
  ...
  void setAntialiasedElements( const QCP::AntialiasedElements
                               &antialiasedElements );
  void setAntialiasedElement( QCP::AntialiasedElement antialiasedElement,
                              bool enabled = true );
  void setNotAntialiasedElements( const QCP::AntialiasedElements
  ...
  bool saveRastered( const QString &fileName, int width, int height, double scale,
                     const char *format, int quality = -1 );
...
public:
  ...
  */
  ...
  void setDataKeyError( const QVector<double> &key, const QVector<double> &value,
                        const QVector<double> &keyErrorMinus, const QVector<double> &keyErrorPlus );
  ...
  void setDataBothError( const QVector<double> &key, const QVector<double> &value,
                         const QVector<double> &keyErrorMinus, const QVector<double> &keyErrorPlus,
                         const QVector<double> &valueErrorMinus, const QVector<double> &valueErrorPlus );
  ...
  virtual void rescaleAxes( bool onlyEnlarge,
                            bool includeErrorBars ) const; // overloads base class interface
  virtual void rescaleKeyAxis( bool onlyEnlarge,
                               bool includeErrorBars ) const; // overloads base class interface
...
protected:
  ...
  virtual QCPRange getValueRange( bool &validRange,
                                  SignDomain inSignDomain = sdBoth ) const;
  virtual QCPRange getKeyRange( bool &validRange, SignDomain inSignDomain,
                                bool includeErrors ) const; // overloads base class interface
  virtual QCPRange getValueRange( bool &validRange, SignDomain inSignDomain,
                                  bool includeErrors ) const; // overloads base class interface
  ...
  void getLinePlotData( QVector<QPointF> *lineData,
                        QVector<QCPData> *pointData ) const;
  void getStepLeftPlotData( QVector<QPointF> *lineData,
                            QVector<QCPData> *pointData ) const;
  void getStepRightPlotData( QVector<QPointF> *lineData,
                             QVector<QCPData> *pointData ) const;
  void getStepCenterPlotData( QVector<QPointF> *lineData,
                              QVector<QCPData> *pointData ) const;
  void getImpulsePlotData( QVector<QPointF> *lineData,
                           QVector<QCPData> *pointData ) const;
...
protected:
  ...
  double pointDistance( const QPointF &pixelPoint ) const;
  QPointF outsideCoordsToPixels( double key, double value, int region,
...
class QCP_LIB_DECL QCPItemText : public QCPAbstractItem
{
  ...
  Q_PROPERTY( Qt::Alignment textAlignment READ textAlignment WRITE
              setTextAlignment )
...
protected:
  ...
  QWeakPointer<QCPAxis> mRangeDragHorzAxis, mRangeDragVertAxis,
               mRangeZoomHorzAxis, mRangeZoomVertAxis;
